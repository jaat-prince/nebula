...
function Sidebar({isOpen, toggleSidebar}) {
  return (
    <div
    className={`fixed inset-0 bg-[black] bg-opacity-50 z-50 transition-transform transform ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}
  >
    <div
    ...
    >
      <div className="flex flex-col p-4">
        ...
        <div className="flex flex-col items-center gap-[30px] xl:gap-[69px]">
          <ul className="flex flex-col gap-[30px] xl:gap-[66px] items-center">
