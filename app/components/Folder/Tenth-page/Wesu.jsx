      ...
      <div className="max-w-[1180px] mx-auto px-4 sm:px-8 md:px-10 lg:px-12">
        ...
        <div className="w-full max-w-[817px]">
          ...
          <p className="text-[var(--Grey,#D7D9DD)] text-sm sm:text-base md:text-lg lg:text-xl font-normal ff-av mt-[32px] lg:mt-[30px]">
            Schedule a dental appointment at Nebula Vets today, and let us
            illuminate your pet's smile for a lifetime of dental wellness and
            happiness. Together, we will nurture their oral health, one shining
            smile at a time.
          </p>
          <Button
            btn={"BOOK NOW"}
