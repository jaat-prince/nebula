      ...
      <div className="max-w-[1180px] mx-auto px-4 sm:px-8 md:px-10 lg:px-12">
        ...
        <div className="w-full relative z-10">
          ...
          <div className="w-full max-w-[1075px] mt-5 md:mt-[38px] lg:mt-[50px]">
            ...
            <p className="text-[var(--Brown,#494336)] text-sm sm:text-base md:text-lg lg:text-xl font-normal ff-av mt-5 lg:mt-[30px]">
              If you notice any signs of dental problems in your pet, such as
              bad breath, red or swollen gums, difficulty eating, or loose
              teeth, it's essential to seek professional dental care. Schedule a
              dental consultation at Nebula Vets to have our skilled team assess
              your pet's dental health and recommend the most appropriate
              treatment options.
            </p>
          </div>
          <div className="w-full max-w-[1075px] mt-5 md:mt-[38px] lg:mt-[50px]">
            ...
            <p className="text-[var(--Brown,#494336)] text-sm sm:text-base md:text-lg lg:text-xl font-normal ff-av mt-5 lg:mt-[30px]">
              ...
              evening of their procedure; soft food for 14 days is recommended
              if any dental extractions were performed. If your pet had any
