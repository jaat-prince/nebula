  ...
  return (
    ...
    <div className='max-w-[1440px] mx-auto px-4 sm:px-8 md:px-10 lg:px-12 md:ml-[65px]'>
        ...
        <div className='w-full max-w-[817px]'>
            ...
            <p  className='text-[var(--Grey,#D7D9DD)] text-sm sm:text-base md:text-lg lg:text-xl font-normal ff-av mt-[32px] lg:mt-[30px]'>Contact Nebula Vets today to schedule a dermatology consultation and let our experienced team bring the sparkle back to your pet's coat. Together, we will help your furry friend shine with healthy skin and a happy disposition. </p>
            <Button
                btn={"BOOK NOW"}
