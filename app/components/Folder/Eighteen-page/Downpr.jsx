  ...
  return (
    <div className="bg-[var(--Grey-2,rgba(215,217,221,0.50))] py-[60px] md:py-[80px] relative overflow-hidden">
      <div className="max-w-[1180px] mx-auto px-4 sm:px-8 md:px-10 lg:px-12">
        ...
        <div className="w-full relative z-10 flex flex-wrap-reverse lg:flex-nowrap">
          <div className="w-full max-lg:mt-[60px] max-sm:max-w-[250px] lg:max-w-[423px]">
            ...
            <p className="text-sm sm:text-base md:text-lg lg:text-xl font-normal text-[var(--Brown,#494336)] mt-5">
              2468 18th Street, SW 
            </p>
            <p className="text-sm sm:text-base md:text-lg lg:text-xl font-normal text-[var(--Brown,#494336)]">
              Washington DC, 20003
            </p>
            ...
            <a
              href="#"
              className="text-sm sm:text-base md:text-lg lg:text-xl font-normal text-[var(--Brown,#494336)] mt-5"
            >
              Phone: (212) 123-4567
            </a>
            <p></p>
            <a
              href="#"
              className="text-sm sm:text-base md:text-lg lg:text-xl font-normal text-[var(--Brown,#494336)]"
            >
